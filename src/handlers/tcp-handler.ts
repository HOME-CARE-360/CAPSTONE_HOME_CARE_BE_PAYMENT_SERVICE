      ...
      case "HANDLE_PAYOS_SUCCESS_MANUAL": {
        if (!data) {
          throw new AppError(
            "Error.MissingData",
            {
              message: "Missing data for HANDLE_PAYOS_SUCCESS_MANUAL",
              path: "data",
            },
            400,
          );
      ...
      case "HANDLE_PAYOS_FAILED_MANUAL": {
        if (!data) {
          throw new AppError(
            "Error.MissingData",
            {
              message: "Missing data for HANDLE_PAYOS_FAILED_MANUAL",
              path: "data",
            },
            400,
          );
      ...
      case "PAY_EXISTING_SERVICE_REQUEST": {
        if (!data) {
          throw new AppError(
            "Error.MissingData",
            {
              message: "Missing data for PAY_EXISTING_SERVICE_REQUEST",
              path: "data",
            },
            400,
          );
